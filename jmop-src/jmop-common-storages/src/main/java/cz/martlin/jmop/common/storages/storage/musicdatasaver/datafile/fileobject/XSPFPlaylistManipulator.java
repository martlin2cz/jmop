...
public class XSPFPlaylistManipulator implements BaseFileObjectManipulator<XSPFFile> {
	...
	public void setTrack(TrackIndex index, Track track, XSPFTrack xtrack)
			throws JMOPPersistenceException {
...
//		XSPFPlaylist xplaylist = playlist(xfile);
	...
	public Track loadTrack(XSPFTrack xtrack, Bundle bundle) throws JMOPPersistenceException {
